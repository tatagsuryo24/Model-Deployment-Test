...
#Labelling masing-masing variabel
...
#Ambil values dari masing-masing variabel di atas
def get_value(val,my_dict):
    for key,value in my_dict.items():
        if val == key:
            return value
        
#Memanggil dan menyimpan model dalam variabel yang sudah ditentukan
@st.cache
...
def run_ml_app():
    ...
    #Memunculkan Drop Down untuk pengisian data
    ...
    #Memunculkan data pada Drop Down supaya bisa diisi sesuai dengan macam-macam data yang sudah kita tentukan 
    ...
    #Memunculkan Value berdasarkan Key yang dimasukkan
    encoded_result = []
